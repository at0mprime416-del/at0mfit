...
const FEATURES = [
  {
    icon: '⚡',
    title: 'AI COACH',
    desc: 'Personalized workouts built from your history. Progressive overload, carb cycling, sleep optimization. Adapts weekly based on your actual data. Pro feature.',
    badge: 'PRO',
  },
  {
    icon: '💪',
    title: 'WORKOUT TRACKER',
    desc: 'Set-by-set logging with rest timers, 1RM calculator, and previous performance displayed inline. Notes per exercise. 100+ movements in the library.',
    badge: null,
  },
  {
    icon: '📊',
  ...
  },
  {
    icon: '🏆',
    title: 'COMPETE',
    desc: 'Wall Street-style leaderboard. AT0M INDEX. Teams. Futures contracts. Token rewards. Real-time updates. The leaderboard looks like a trading floor — because competition should feel like high stakes.',
    badge: null,
  },
  {
    icon: '🏃',
    title: 'LIVE RUN TRACKING',
    desc: 'GPS route on Google Maps, real-time pace, distance, and duration. Mileage charts over time. Every mile logged, every split analyzed.',
    badge: null,
  },
  {
    icon: '🥗',
    title: 'NUTRITION + SLEEP',
    desc: 'Meal logging with macros, supplement tracker, and sleep quality tracking. All feeds the AI coach so your program actually accounts for recovery.',
    badge: null,
  },
  {
    icon: '📷',
    title: 'FORM CHECK',
    desc: 'Record your lifts directly in the app. Review form with full camera playback. Progress photo grid with before/after comparison. Document the transformation.',
    badge: null,
  },
  {
    icon: '🗓️',
...
const PRO_FEATURES = [
  ...
  '⚡ AI Workout Generator — adaptive program based on your history',
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-28 pb-20 overflow-hidden">
        {/* Glow — gold not blue */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle,rgba(201,168,76,0.10)_0%,transparent_65%)] pointer-events-none" />
        ...
        {/* Subheadline */}
        <p className="max-w-xl text-lg text-[#888] leading-relaxed mb-10">
      ...
      {/* ── COMPETE SPOTLIGHT ── */}
      <section className="bg-[#0a0a0a] py-20 px-6 border-t border-[#222]">
          ...
          <div className="bg-[#111] border border-[#C9A84C] rounded-2xl p-10 md:p-14 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-[#888] text-lg leading-relaxed max-w-2xl mb-8">
                Because competition should feel like high stakes. The Compete screen is a Wall Street-style fitness exchange — AT0M INDEX tracking platform activity, teams with market cap rankings, futures contracts, real-time token updates, and live countdowns.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 text-sm text-[#888]">
                  <span className="text-[#C9A84C]">✓</span> Global leaderboard
                </div>
                <div className="flex items-center gap-2 text-sm text-[#888]">
                  <span className="text-[#C9A84C]">✓</span> Team formation &amp; ranking
                </div>
                <div className="flex items-center gap-2 text-sm text-[#888]">
                  <span className="text-[#C9A84C]">✓</span> Open competitions
                </div>
                <div className="flex items-center gap-2 text-sm text-[#888]">
                  <span className="text-[#C9A84C]">✓</span> Token rewards
                </div>
                <div className="flex items-center gap-2 text-sm text-[#888]">
                  <span className="text-[#C9A84C]">✓</span> Real-time updates
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#888] text-base max-w-lg mx-auto leading-relaxed">
              Built for operators, athletes, and anyone who trains with intention. No bloat — just the tools that actually move the needle.
            </p>
            ...
            {[
              {
                ...
                desc: 'Set your goals, fitness level, and body composition. This is the foundation — the AI uses this baseline to calibrate everything.',
              },
              {
                num: '02',
                icon: '📋',
                title: 'TRAIN AND LOG EVERYTHING',
                desc: 'Every workout, run, meal, and night of sleep. The more data you feed it, the smarter your coaching becomes.',
              },
              {
                num: '03',
                icon: '⚡',
                title: 'AI PRESCRIBES YOUR PROGRAM',
                desc: 'Your AI coach adapts weekly based on your actual data — progressive overload, carb cycling, recovery windows, all auto-calculated.',
              },
      ...
      {/* ── WAITLIST CTA ── */}
      <section id="waitlist" className="relative bg-[#0a0a0a] py-24 px-6 overflow-hidden">
